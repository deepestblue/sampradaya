...
| psts  | S4   | 3     | Ligates a base glyph and a post‐base glyph. Used here to select the right i/ī‐markers and post‐rēpha marker, and to rearrange various markers. | 𑌕𑍍𑌰𑌿 |

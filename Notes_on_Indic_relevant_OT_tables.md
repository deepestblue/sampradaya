...
| vatu  | S4   | 2     | Replaces consonant+virāma+rēpha with a new glyph. Not used here. | न्र |
...
| psts  | S4   | 3     | Ligates a base glyph and a post‐base glyph. Used to select the right i/ī‐markers and post‐rēpha marker. | 𑌜𑍍𑌞𑌿 |
